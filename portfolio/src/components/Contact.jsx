      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-black mt-4 mb-6">
            <span style={{color: 'var(--text-heading)'}}>Let's </span>
        ...
        <div className="grid sm:grid-cols-3 gap-5 mb-16">
          {LINKS.map((link, i) => (
            ...
            >
              <div
                className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4 text-white group-hover:scale-110 transition-transform duration-300"
                style={{background: link.gradient}}
              >
                {link.icon}
              </div>
              <h3 className="text-lg font-bold mb-2" style={{color: 'var(--text-heading)'}}>{link.name}</h3>
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 rounded-2xl blur-xl" style={{background: 'var(--accent-glow)'}} />
            <div className="relative">
